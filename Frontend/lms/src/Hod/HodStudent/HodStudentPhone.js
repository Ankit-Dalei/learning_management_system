...
const HodStudentPhone = (props) => {
  ...
  return (
    ...
    <div className='col-12 col-md-7 d-flex flex-column justify-content-center'>
      ...
      <div className='mb-2'><span>BATCH: {props.batch+"   "} {"Section: "+props.section}</span></div>
      ...
      <div className='d-flex justify-content-center mt-3'>
        <button className='btn btn-sm btn-outline-warning' onClick={()=>{navigate('/Hod/Student/StudentDetails',{state: {data: data}})}}>View</button>
...
export default HodStudentPhone
